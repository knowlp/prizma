...
public class IO {
    ...
    /**
     * Bir dosyanın belirtilen adreste olup olmadığını döndürür<br/> Ör:
     * IO.exists("dosyalarım/dosyam.txt");
     */
    ...
    /**
     * Bir dosyayı okuyup bütünüyle string olarak döndürür. Dosya Unicode
     * biçiminde ise sorunsuz çalışır. Aksi halde Türkçe karakterlerde sorun
     * yaşamamak için (Dosya Türkçe karakterler içeriyorsa ve Unicode biçiminde
     * değilse): read("beni_oku.txt", "ISO-8859-9") şeklinde kullanılmalıdır
     * <br><br>Not: Yine de Türkçe karakter içeren dosyalarınızı her zaman
     * unicode biçiminde kaydetmeniz tavsiye edilir.
     */
    public static String read(String file) {
        return read(file, UTF_8);
    }

    public static String read(String file, boolean encodedBase64) {
        if(encodedBase64){
     ...
     * kullanılmaz! <br/> Ör: copy("beni_kopyala.txt", "bana_kopyala.txt");
     */
     ...
     * kullanılmaz!<br/> Ör: copy(new File("beni_kopyala.txt"), new
     * File("bana_kopyala.txt"));
     */
    ...
    /**
     * String'i Base64 biçiminde kodlayarak dosyaya yazar.
     * Böylece dosya insanlar tarafından okunamayacak biçimde kaydedilir.
     * Bu biçimdeki dosyayı readBase64 metod ile okumak gerekir.
     */
     ...
     */
    public static List<String> readLines(String filePath, boolean encodedBase64) {
        if (encodedBase64){
            String str = read(filePath, encodedBase64);
            return splitIntoLines(str);
        }
    ...
    public static List<String> readLines(String filePath, String encoding) {
        return splitIntoLines(read(filePath, IO.UTF_8));
    }
    ...
    /**
     * Bir dosyadaki satırları sonlarıdaki new_line karakterleri ile birlikte
     * okur ve liste (ArrayList) olarak döndürür.
     */
